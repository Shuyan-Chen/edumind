...
import com.shuyan.edumind.viewmodel.admin.file.UeditorConfigVM;
import com.shuyan.edumind.viewmodel.admin.file.UploadResultVM;
...
public class UploadController extends BaseApiController {
    ...
    public RestResponse questionUploadAndReadExcel(HttpServletRequest request) {
        ...
        try (InputStream inputStream = multipartFile.getInputStream()) {
            ...
            userService.changePicture(getCurrentUser().getId(), filePath);
